            ...
            <div className="loginpage">
               ...
               <form  onSubmit={this.handleSubmit}>
                    <div>
                        ...
                        <input type='text' name="id" value={this.state.empId} onChange={this.handleChange}placeholder="Enter unique ID" required/>
                    </div>
                    <div>
                        <label>User Name:</label>
                        <input type='text' name="name" value={this.state.username} onChange={this.handleChange}placeholder="Enter Username" required/>
                    </div>
                    <div>
                        <label>Password     :</label>&nbsp;&nbsp;
                        <input type='password' name="jobrole" value={this.state.username} onChange={this.handleChange} placeholder="Enter valid Password" required/>
                    </div>
                    <div>
                        {/* <label>Submit</label> */}
